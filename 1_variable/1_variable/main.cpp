...
int main()
{
	...
	//int 자료형
	//최초 16bit 아키텍처 일때는 16bit
	//32bit 아키텍처 일때는 32bit
	//64bit 아키텍처 일때는 32bit
	//int64 = 64bit
	int A = 0;//숫자, 음수, 양수, 정수(0, 1, 2, 3, 4)
	...
	//10101.1101(21.8125) -> 0.101011101 * 2^5->(5승을 2진법으로 바꾸면 101)
	// 0  /  000 0010 1 / 101 0111 0100 0000 0000 0000
	// 명확하게 0.1을 표기하려고 한다면 0000 0001 ???? ????
	//float a = 1.0;
	//int n = 1;
	// n = a ??  1 = 0.99999999999999999999999999998
	
	double d = 0.1;//8byte float 보다 더 정밀하다
	
	//int 1 = 0000 0001
	//float 1 = 0001 0001 1000000
	...
	// 실수끼리는 나머지 연산 불가능(몇번째 소수점 자리를 기준으로 연산을 해야하는지 알수없음)
	...
	// 논리 연산자
	// &&(AND) , ||(OR), !(NOT)
	// and = 둘다 참이면 참, 그렇지 아니면 거짓
	// or = 둘중에 하나라도 참이면 참, 그렇지 아니면 거짓
	// not = 참이면 거짓, 거짓이면 참
	// YES : 0이 아닌 값, TRUE(1)
	// NO : 0이면, FALSE(0)
	//bool bResult = true;
	...
	//주석 : 컴파일에 포함되지않는 문자로 코드로 인식하지않는다
	/*주석 : 컴파일에 포함되지않는 문자로 코드로 인식하지 않는다*/
